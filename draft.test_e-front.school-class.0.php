 ...
 * View: school-class
 * Column count: 5
 * Filename: draft.test_e-front.school-class.1.php
 * Created Thu, 01 Jun 2017 23:40:03 +0200
 ...
 * Null columns: school-class_name, school-class_desc
 * All columns: id_school_class, ypokatastima_idypokatastima, ypokatastima_company_idcompany,
school-class_name, school-class_desc
*/
...
$opts['sort_field'] = array('-id_school_class');

$opts['key'] = 'id_school_class'; // primary key
...
# RENAMING OUT PUT FILE: draft.test_e-front.school-class.0.php
...
// column 0: `id_school_class` int(11)
// flags: auto_increment

$opts['fdd']['id_school_class'] = array(
...
// $opts['fdd']['id_school_class']['tab|ACP'] = 'Id School Class';


// column 1: `ypokatastima_idypokatastima` int(11)

$opts['fdd']['ypokatastima_idypokatastima'] = array(
  'css'        => array('postfix' => 'right-justify'),
  'default'    => '',
  'input'      => '',
  'maxlen|ACP' => 10,
//  'number_format|VDFL' => array(0, '.', ','),
  'name'       => 'Ypokatastima Idypokatastima',
  'options'    => 'ACPVDFL',
  'select'     => 'T',
  'size'       => 10,
  'sqlw'       => 'TRIM("$val_as")',
...
// column 2: `ypokatastima_company_idcompany` int(11)

$opts['fdd']['ypokatastima_company_idcompany'] = array(
  'css'        => array('postfix' => 'right-justify'),
  'default'    => '',
  'input'      => '',
  'maxlen|ACP' => 10,
//  'number_format|VDFL' => array(0, '.', ','),
  'name'       => 'Ypokatastima Company Idcompany',
  'options'    => 'ACPVDFL',
  'select'     => 'T',
  'size'       => 10,
  'sqlw'       => 'TRIM("$val_as")',
...
// column 3: `school-class_name` varchar(45)

$opts['fdd']['school-class_name'] = array(
  'default'    => '',
  'input'      => '',
  'maxlen|ACP' => 45,
...
// column 4: `school-class_desc` varchar(45)

$opts['fdd']['school-class_desc'] = array(
  'default'    => '',
  'input'      => '',
  'maxlen|ACP' => 45,
  'name'       => 'School Class Desc',
  'options'    => 'ACPVDFL',
  'select'     => 'T',
  'size'       => 45,
  'sqlw'       => 'IF($val_qas = "", NULL, $val_qas)',
